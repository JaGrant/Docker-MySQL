...
CREATE TABLE `users` (
  ...
  `joined` varchar(120) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `users` VALUES (4,'JayG','Jason','Grant','jasongrant@serverfox.co.uk','male','$2y$10$WbbaPDr5OwWF2Ak3kNVi5edgyptJITZ4/VKk180Dlz3MVDbIAhmXO','2017-02-02 05:58:25'),(5,'JayG1','Jason','Grant','jasongrant@serverfox.co.uk','male','$2y$10$OQWwmS6bGXfMXyr0e3MBSepzjq9rP5VU7K3WWo.algE3jSEX11hjC','2017-02-05 20:40:43'),(7,'klasjd','dkjfgk','skldjfkl','jasongrant@serverfox.co.uk','male','$2y$10$v1aO51z/EG/A.x9nEsn6uOut.U7HN6QP2Ut/HSOeBfZ56JztWUPxC','2017-02-20 03:48:41'),(8,'jayg2','Jay','Grant','jasongrant@serverfox.co.uk','male','$2y$10$eoOtTsr8Ng6UEyRymwmM6uvP3qDt/YCI2H5mMMNczjMFO5gw9Vh8O','2017-02-22 02:53:45'),(9,'jayg3','Jay','Grant','jasongrant@serverfox.co.uk','male','$2y$10$zMs9mM4M8S7T88UCi/FhG.9UqJ9N2pFzmuKFogjfaHH8stkvQ9QCq','2017-02-22 23:48:14');
...
-- Dump completed on 2017-06-21  4:58:01
